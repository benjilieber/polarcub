...
def main():
    ...
    if numberOfEncodingDecodingTrials is not None:
        ...
        BinaryPolarEncoderDecoder.encodeDecodeSimulation(N, make_xVectorDistribuiton, make_codeword, simulateChannel,
                                                         make_xyVectorDistribution, numberOfEncodingDecodingTrials,
                                                         frozenSet, commonRandomnessSeed=args['common_randomness_seed'],
                                                         randomInformationSeed=args['information_seed'],
                                                         verbosity=verbosity)
